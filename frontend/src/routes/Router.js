...
const Certificates = Loadable(lazy(() => import('./../views/student/Certificates')));
const CertificateVerify = Loadable(lazy(() => import('../views/CertificateVerify')));
...
const BranchAnalytics = Loadable(lazy(() => import('./../views/teacher/BranchAnalytics')));
...
const AnalyticsRoute = Loadable(lazy(() => import('src/views/authentication/AnalyticsRoute')));
    ...
    <>
      ...
      <Route path="" element={<PrivateRoute />}>
        ...
        <Route path="/" element={<FullLayout />}>
          ...
          <Route path="/certificates" exact={true} element={<Certificates />} />
          ...
          <Route path="" element={<AnalyticsRoute />}>
            <Route path="/analytics" exact={true} element={<BranchAnalytics />} />
          </Route>
        </Route>
      ...
      {/* Public certificate verification (QR-code target — no auth required) */}
      <Route path="/verify" element={<BlankLayout />}>
        <Route path=":code" element={<CertificateVerify />} />
      </Route>
