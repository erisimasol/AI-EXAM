...
import SecureBrowserGuard from './Components/SecureBrowserGuard';
  ...
  const handleTestSubmission = async () => {
    ...
    try {
      ...
      const updatedLog = {
        ...
        examId: examId,
        branch: userInfo.branch || cheatingLog.branch || '',
        department: userInfo.department || cheatingLog.department || '',
        ...
        copyPasteAttemptCount: parseInt(cheatingLog.copyPasteAttemptCount) || 0,
        fullscreenExitCount: parseInt(cheatingLog.fullscreenExitCount) || 0,
      };
